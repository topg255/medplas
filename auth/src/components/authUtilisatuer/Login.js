...
function MedicalTouristLogin() {
  ...
  const images = [
    ...
    },
    {
      ...
      description: 'Our hospitals combine advanced technology with compassionate care',
    },
    {
      src: recoveryResort,
      alt: 'Luxury Recovery Resort',
      caption: 'Premium Recovery Destinations',
      description: 'Recover in luxury at our 5-star medical recovery resorts',
    },
    {
      src: medicalTeam,
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (
          ...
          errorMessage.includes('Internal server error') // Assuming this might be returned for password errors
        ) {
          setErrors((prev) => ({ ...prev, password: 'Your password is incorrect' }));
      ...
      // Wait for MF2 to signal readiness
      const listener = (event) => {
        if (event.origin === 'http://localhost:3020' && event.data === 'READY_FOR_TOKEN') {
          newTab.postMessage(
            {
              type: 'TOKEN_TRANSFER',
              accessToken,
                          ...
                          {images.map((_, i) => (
                            <button
                              ...
                              className={`h-1 rounded-full transition-all ${
                                i === activeImage ? 'bg-white w-6' : 'bg-white/50 w-3'
                              }`}
        ...
        <div className="md:w-1/2 flex items-center justify-center p-8 md:p-12 lg:p-16">
          ...
          >
            <div className="text-center mb-8">
              <h2 className="text-3xl font-munika text-blue-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    type="email"
                    id="email"
                    className={`block font-munika w-full pl-10 pr-3 py-3 border rounded-lg transition-all bg-gray-50 ${
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-sm font-munika text-blue-600 hover:text-blue-500"
                  >
                    Forgot password?
                  </Link>
                </div>
                <div className="relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    id="password"
                    className={`block w-full font-munika pl-10 pr-10 py-3 border rounded-lg transition-all bg-gray-50 ${
              ...
              <div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-munika text-white transition-all hover:shadow-md active:scale-[0.98] ${
                    isLoading
...
export default MedicalTouristLogin;