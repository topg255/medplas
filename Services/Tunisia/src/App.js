...
import {MedicalDestinations} from './components/destination'
import {TestimonialsGallery} from './components/galerie'
    ...
    return (
        ...
        <>
            ...
            <div className="w-full h-full bg-[#f8fbff]">
                ...
                <WhyTunisia></WhyTunisia>
                <MedicalDestinations></MedicalDestinations>
                <TestimonialsGallery></TestimonialsGallery>
