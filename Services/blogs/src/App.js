...
import {MedicalTreatmentsSection} from './components/medsection';
import{EnhancingJourneySection} from './components/featuresection';
import {DiscoverBestSelfSection} from './components/discoversection';
import { TestimonialsSection} from './components/testo';
    ...
    return (
        ...
        <>
            ...
            <div className="w-full h-full bg-[#f8fbff]">
                ...
                <MedicalTreatmentsSection></MedicalTreatmentsSection>
                <EnhancingJourneySection></EnhancingJourneySection>
                <DiscoverBestSelfSection></DiscoverBestSelfSection>
