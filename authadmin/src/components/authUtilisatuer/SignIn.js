...
const SignIn = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    password: '',
    role: 'admin' // Nouveau champ role avec valeur par défaut
  });
  ...
  const handleSubmit = async (e) => {
    ...
    const userData = {
      ...
      role: formData.role // Ajout du rôle dans les données envoyées
    };
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-munika text-gray-700 mb-1">Role</label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <HiOutlineIdentification className="h-5 w-5 text-gray-400" />
                      </div>
