...
const PAGE_CONFIG = {
  id: "dentistry",
  titleKey: "dentistry_hero_title",
  descriptionKey: "dentistry_hero_desc",
  videoSrc: URL('https://res.cloudinary.com/dk8b4jqbb/video/upload/v1766049752/vb_klxt0e.mp4'),
  nextPage: "http://localhost:3029/",
  prevPage: "http://localhost:3031/"
};
    ...
    <div className="relative w-full flex flex-col h-full">
      ...
      {PAGE_CONFIG.prevPage && (
        <motion.a
          ...
          className="fixed left-0 top-1/2 z-40 border-yellow-500 bg-yellow-200/90 hover:bg-yellow-400/95 transition-all duration-300 ease-out shadow-xl flex flex-col items-center justify-center h-36 w-12 rounded-r-xl border-r-4 border-t border-b"
          whileHover={{
            backgroundColor: "rgba(254, 245, 231)"
          }}
          transition={{ type: "spring", stiffness: 400, damping: 25 }}
          style={{ transform: 'translateY(-50%)' }}
        >
          <div className="flex flex-col items-center gap-2">
            <div className="writing-vertical text-sm font-medium text-yellow-600 tracking-wide"
      ...
      {PAGE_CONFIG.nextPage && (
        <motion.a
          ...
          className="fixed right-0 top-1/2 z-40 bg-rose-100/90 hover:bg-rose-200/95 transition-all duration-300 ease-out shadow-xl flex flex-col items-center justify-center h-36 w-12 rounded-l-xl border-l-4 border-t border-b border-pink-600"
          whileHover={{
            backgroundColor: "rgba(255, 191, 245)"
          }}
          transition={{ type: "spring", stiffness: 400, damping: 25 }}
          style={{ transform: 'translateY(-50%)' }}
        >
          <div className="flex flex-col items-center gap-2">
            <div className="writing-vertical text-sm font-munika text-pink-600  tracking-wide"
        ...
        <div className="relative container mx-auto px-4 py-4 mt-20 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-white">
            ...
            >
              ...
              {t("curve_offer_best")}<br />{t(PAGE_CONFIG.titleKey)}
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
