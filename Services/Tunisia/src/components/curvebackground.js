...
//import Da from '../assets/call.mp4'
//import D from '../assets/ved.mp4'
          ...
          <div className="md:w-1/2 text-white">
            ...
            <div className="flex space-x-4 items-center">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                className="text-white bg-blue-600/90 hover:bg-blue-700 rounded-full p-4 transition-all duration-300 shadow-lg"
                aria-label="Play video"
              >
                <FiPlay size={24} />
              </motion.button>
              <h1 className="font-munika">Watch all video </h1>
            </div>
          </div>
        </div>
      </div>
