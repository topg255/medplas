...
function Profile() {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/users/travelagency/update', {
        method: 'POST', // Corrected to POST as per API expectation
        headers: {
      ...
      localStorage.setItem('location', updatedUser.location || userData.location);
        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <FaMapMarkerAlt className="h-6 w-6 text-blue-600 mr-3" />
                <div>
                  <p className="text-sm font-munika text-gray-600">Location</p>
                  <p className="text-lg font-munika text-gray-900">{userData.location || 'Not specified'}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              {/* Location Field */}
              <div>
                <label htmlFor="location" className="block text-sm font-munika text-gray-700 mb-1">
                  Location
                </label>
                <div className="relative rounded-md shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
