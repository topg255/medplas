...
import backgroundImage from '../assets/ht3.jpg';
        ...
        <>
            <div className="flex flex-col lg:flex-row items-center justify-center mt-20 mb-20 lg:mt-32 gap-12 lg:gap-24 px-6 max-w-7xl mx-auto">
                ...
                >
                    ...
                    >
                        <span className="text-orange-800 font-munika">{t("hair_transplant_in_tunisia")}</span>
                    </motion.h1>

                    <div className="space-y-5">
                        <motion.div
                            className="p-5 bg-orange-50/30 rounded-lg border border-orange-100"
                            whileHover={{ x: 3 }}
                        ...
                        >
                            <h3 className="font-semibold text-orange-700 flex items-center">
                                ...
                                {t("hair_medical_expertise")}
                            </h3>
                            <p className="mt-2 text-gray-700 font-munika">
                                {t("hair_medical_expertise_desc")}
                            </p>
                        </motion.div>
                        ...
                        >
                            <h3 className="font-munika text-orange-700 flex items-center">
                                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" />
                                </svg>
                                {t("hair_advanced_technology")}
                            </h3>
                            <p className="mt-2 text-gray-700 font-munika">
                                {t("hair_advanced_technology_desc")}
                            </p>
                        </motion.div>
                        ...
                        >
                            <h3 className="font-munika text-orange-700 flex items-center">
                                ...
                                {t("hair_complete_support")}
                            </h3>
                            <p className="mt-2 text-gray-700 font-munika">
                                {t("hair_complete_support_desc")}
                            </p>
                        </motion.div>
                    </div>
                    ...
                    >
                        <motion.button
                            className="px-8 py-3 bg-orange-600 text-white rounded-lg font-munika shadow-md hover:shadow-lg transition-all flex items-center justify-center"
                        ...
                        >
                            ...
                            {t("make_hair_appointment")}
                        </motion.button>
                        <motion.button
                            className="px-8 py-3 bg-white text-orange-600 border border-orange-200 rounded-lg font-munika shadow-sm hover:shadow-md transition-all flex items-center justify-center"
                        ...
                        >
                            <div className="p-6">
                                <div className="flex justify-between items-center mb-6">
                                    <h3 className="text-2xl font-munika text-gray-900">{t("hair_process_title")}</h3>
                                    <button
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        >
                                            <div className="relative rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                                                <img
                                                    src={backgroundImage}
                                                    alt={t("hair_before_alt")}
                                                    className="w-full h-auto"
                                                />
                                                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                                                    <span className="text-white text-sm font-medium">{t("hair_before_label")}</span>
                                                </div>
                                            </div>
                                        ...
                                        >
                                            <div className="relative rounded-lg overflow-hidden border border-gray-200 shadow-sm">
                                                <img
                                                    src={Image}
                                                    alt={t("hair_after_alt")}
                                                    className="w-full h-auto"
                                                />
                                                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                                                    <span className="text-white text-sm font-medium">{t("hair_after_label")}</span>
                                                </div>
                                            </div>
                                            <p className="text-gray-600 text-sm font-munika px-2">
                                                {t("hair_after_desc")}
                                    ...
                                    <div className="space-y-4">
                                        <div className="relative rounded-lg overflow-hidden border border-gray-200 shadow-md hover:shadow-lg transition-shadow duration-300">
                                            <video
                                                ...
                                                loop
                                                muted
                                                src = {URL('https://res.cloudinary.com/dk8b4jqbb/video/upload/v1766052697/hair_pljixl.mp4')}
                                                alt={t("hair_process_video_alt")}
                                                className="w-full h-auto cursor-pointer"
                                                onClick={() => setIsVideoExpanded(true)}
                                            />
                                            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
                                                <span className="text-white text-sm font-medium">{t("hair_process_label")}</span>
                                            </div>

                                            {/* Bouton d'agrandissement amélioré */}
                                            <button
                                                onClick={() => setIsVideoExpanded(true)}
                                                className="absolute top-2 right-2 bg-white/90 hover:bg-white text-gray-800 rounded-full p-2 shadow-md transition-all duration-200 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-orange-500"
                                            ...
                                            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                                                ...
                                                <div className="relative w-full max-w-4xl bg-white rounded-xl overflow-hidden shadow-2xl z-10">
                                                    ...
                                                    <video
                                                        ...
                                                        controls
                                                        src={URL('https://res.cloudinary.com/dk8b4jqbb/video/upload/v1766052697/hair_pljixl.mp4')}
                                                        alt={t("hair_process_video_expanded_alt")}
                                ...
                                <div className="mt-8 bg-orange-50/50 p-6 rounded-lg">
                                    <h4 className="font-munika text-orange-700 mb-3 flex items-center">
                                        <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        {t("hair_info_title")}
                                    ...
                                    <motion.a
                                        href="https://en.wikipedia.org/wiki/Hair_transplantation"
                                        className="mt-2 text-orange-600 text-sm font-munika hover:text-orange-800 transition-colors duration-200 underline underline-offset-4 decoration-orange-300 hover:decoration-orange-600 cursor-pointer inline-flex items-center"
                                        whileHover={{ x: 2 }}
                                        whileTap={{ scale: 0.98 }}
                                    >
                                        {t("hair_info_link")}
                                ...
                                <div className="mt-6 flex justify-end">
                                    <button
                                        onClick={() => setIsResultsModalOpen(false)}
                                        className="px-6 py-2 bg-orange-600 text-white rounded-lg font-munika shadow hover:bg-orange-700 transition-colors"
                                    >
                                        {t("close")}
                                    </button>
                                </div>
