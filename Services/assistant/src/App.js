...
import {MedicalTravelAssistantForm} from './components/assisstant'
import {ServicesMap} from './components/carteservice'
import {RecommendedAccommodations} from './components/recomandation';
    ...
    return (
        ...
        <>
            ...
            <div className="w-full h-full bg-[#f8fbff]">
                ...
                <MedicalTravelAssistantForm></MedicalTravelAssistantForm>
