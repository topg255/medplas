...
import {MedicalBookingForm} from './components/nedical';
import {RelatedServices} from './components/Assistant';
import {PatientSupport} from './components/Quiz';
import {TestimonialsSection} from './components/temoi';
export const Navbar = () => {
    const testimonials = [
        {
            quote:
    ...
    return (
        ...
        <>
            ...
            <div className="w-full h-full bg-[#f8fbff]">
                ...
                <MedicalBookingForm></MedicalBookingForm>
