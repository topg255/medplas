      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-800 to-blue-700 text-white p-6 rounded-lg w-full max-w-lg shadow-xl cursor-default relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl font-bold text-center font-munika mb-2">
                Medical appointment
              </h3>
              <p className="text-center mb-6 font-munika">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => setIsOpen(false)}
                  className="bg-transparent hover:bg-white/10 transition-colors text-white font-munika w-full py-2 rounded "
                >
                  Go back
                </button>
                <button
                  onClick={() => setIsOpen(false)}
                  className="bg-white hover:opacity-90 transition-opacity text-blue-800 font-munika w-full py-2 rounded"
                >
                  Make Appointment!
                </button>
              </div>
