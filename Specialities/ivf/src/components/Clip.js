            ...
            >
                ...
                {options && (
                    <motion.span
                        ...
                        className="text-rose-500 font-munika"
                    >
            ...
            <AnimatePresence>
                {options && isOpen && (
                    <motion.ul
                        ...
                        className="absolute top-full mt-1 left-0 w-56 bg-white shadow-xl rounded-lg overflow-hidden p-2 pointer-events-auto border border-rose-100 z-50"
                        style={{ originY: 0 }}
                    >
                        {options.map((option, i) => (
                            <motion.li
                                ...
                                className="px-3 py-2 text-gray-700 hover:bg-rose-50 rounded-md transition-colors text-sm cursor-pointer font-munika"
                                whileHover={{
                                    x: 5,
